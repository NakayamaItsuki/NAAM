...
file_path="${results_dir}/vanilla_MLP.txt"
conf_name="${base_dir}/conf_ratio=${ratio}/vanilla_MLP_conf.yaml"
...
python -W ignore train_student.py --agg $agg --dataset cora --hidden_channels 64 \
    --teacher_models_name "GCN" --teacher_hidden_channels 64 --teacher_layers 2 \
