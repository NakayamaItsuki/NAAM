...
file_path="${results_dir}/MTAAM.txt"
conf_name="${base_dir}/conf_ratio=${ratio}/MTAAM_conf.yaml"
...
python -W ignore train_student.py --agg $agg --dataset cora --hidden_channels 64 \
    --teacher_models_name "GCN" "GAT" "SGC" "APPNP" "GCN2" \
    --teacher_hidden_channels 64 64 64 64 64 \
    --teacher_layers 2 2 2 2 64 \
...
python -W ignore train_student.py --agg $agg --dataset citeseer --hidden_channels 64 \
    --teacher_models_name "GCN" "GAT" "SGC" "APPNP" "GCN2" \
    --teacher_hidden_channels 64 64 64 64 256 \
    --teacher_layers 2 2 2 2 32 \
    --ratio $ratio --mode ind \
    --config_name $conf_name \
    --output_only_results True \
    --device $device --n_runs 10 >> $file_path
