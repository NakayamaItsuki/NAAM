...
file_path="${results_dir}/GLNN_GAT.txt"
conf_name="${base_dir}/conf_ratio=${ratio}/GLNN_GAT_conf.yaml"
...
python -W ignore train_student.py --agg $agg --dataset cora --hidden_channels 64 \
    --teacher_models_name "GAT" --teacher_hidden_channels 64 --teacher_layers 2 \
