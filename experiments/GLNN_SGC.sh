...
file_path="${results_dir}/GLNN_SGC.txt"
conf_name="${base_dir}/conf_ratio=${ratio}/GLNN_SGC_conf.yaml"
...
python -W ignore train_student.py --agg $agg --dataset cora --hidden_channels 64 \
    --teacher_models_name "SGC" --teacher_hidden_channels 64 --teacher_layers 2 \
